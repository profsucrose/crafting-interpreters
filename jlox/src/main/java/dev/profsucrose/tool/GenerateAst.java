...
public class GenerateAst {
    final static String OUTPUT_DIR = "jlox/src/main/java/dev/profsucrose/lox";
    ...
    private static void defineAst(String baseName, List<String> types) throws IOException {
        final String path = String.format("%s/%s.java", OUTPUT_DIR, baseName);
        ...
        defineVisitor(baseName, writer, types);
    ...
    private static void defineVisitor(String baseName, PrintWriter writer, List<String> types) {
