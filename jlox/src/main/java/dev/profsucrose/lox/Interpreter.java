...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Object visitTernaryExpr(Expr.Ternary expr) {
        ...
        if (!(condition instanceof Boolean)) {
            throw new RuntimeError(expr.ternary, "First expression in a ternary must evaluate to a boolean.");
        }
    ...
    private String stringify(Object object) {
        ...
        if (object instanceof Double) {
            ...
            if (text.endsWith(".0")) {
                // remove decimal in string if number is whole
    ...
    private boolean isTruthy(Object object) {
        // follows Ruby's "truthy-ness" rules,
        // value is false if null or boolean false,
        // otherwise true
